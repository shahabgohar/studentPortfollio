...
<template>
    <button class="cosmic-btn flex items-center justify-center max-sm:px-3 max-sm:py-1 max-lg:px-6 py-3.5 px-12 rounded-md transition-all duration-300 hover:scale-105">
