...
const faqs = [
  ...
  },
  {
    ...
    a: 'Book a 30-minute build call or email the brief. We scope the highest-value workflow first and I build a working version with real data, typically a usable demo inside 14 days, then we harden it for production.'
  },
  {
